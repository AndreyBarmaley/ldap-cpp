...
namespace Ldap
{
	...
	const std::vector<Berval *> & BinaryValues(void) const;
	const std::vector<char *> & StringValues(void) const;
	...
	std::string type;
	std::vector<Berval *> bvals;
	std::vector<char *> strvals;
    };
};
